...
public class Registers {
    ...
    private ArrayList<Reg> tempRegs = new ArrayList<>(Arrays.asList(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9, A0,A1,A2,A3,V1,RA)); // todo 把v0怎么加进来呢？
    ...
    public ArrayList<Reg> getUsedTRegs() {
